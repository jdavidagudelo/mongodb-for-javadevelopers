...
public class BlogController {
    ...
    public static void main(String[] args) throws IOException {
        if (args.length == 0) {
            new BlogController("mongodb://jdavidagudelo:namadaju1037524435@ds043981.mongolab.com:43981/heroku_app33880272");
        }
        else {
    ...
    public BlogController(String mongoURIString) throws IOException {
        ...
        final DB blogDatabase = mongoClient.getDB("heroku_app33880272");
